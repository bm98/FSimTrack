...
namespace FSimTrack
{
  static class Program
  {
    ...
    static void Main( )
    {
      ...
      Console.WriteLine( "FSimTrack - current culture : {0}", modded.Name );
      Console.WriteLine( "FSimTrack - current decimal separator : {0}", modded.NumberFormat.NumberDecimalSeparator );
      var us = new CultureInfo( "en-US" );
      modded.NumberFormat = us.NumberFormat;  // change the whole number format to US - should be safe ...
      Console.WriteLine( "FSimTrack - newly used decimal separator : {0}", modded.NumberFormat.NumberDecimalSeparator );
